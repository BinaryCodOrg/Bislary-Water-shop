...
contextBridge.exposeInMainWorld("api", {
  ...
  updateOrderStatus: (orderId, newStatus) => ipcRenderer.invoke("order:updateStatus", { orderId, newStatus }),
  ...
  updateDuePayment: (id, paid_amount) => ipcRenderer.invoke("due:updatePayment", { id, paid_amount }),
  // Delivery Boys
  ...
  assignOrderDelivery: (order_id, delivery_boy_id) => ipcRenderer.invoke("orderDelivery:assign", { order_id, delivery_boy_id }),
  ...
  markOrderComplete: ({ orderId, amount_paid, payment_method, deliveryBoy }) => ipcRenderer.invoke("order:markComplete", {
    orderId,
    amount_paid,
    payment_method,
    deliveryBoy
