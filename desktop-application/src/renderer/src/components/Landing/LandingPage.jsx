...
const LandingPage = () => {
  ...
  const [houseNumbersArray, setHouseNumbersArray] = useRecoilState(HouseNumbersArray)

  let [delivaryBoysArray, setDelivaryBoysArray] = useRecoilState(DelivaryBoysArray)
  let [expancesArray, setExpancesArray] = useRecoilState(ExpancesArray)
  let [weeklySummary, setWeeklySummary] = useRecoilState(WeeklySummary)
  ...
  async function FetchOrders() {
    ...
    try {
      ...
      const getWeekly = await window.api.getWeeklySummary()
      console.log(getWeekly, 'getWeekly')
      setWeeklySummary(getWeekly)
